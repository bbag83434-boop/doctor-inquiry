    ...
    <div className="dashboard-shell">
      <main className="dashboard" aria-label="Home dashboard">
        ...
        <section className="dashboard-section" aria-labelledby="quick-actions-title">
          ...
          <div className="quick-actions-grid">{actions.map((action) => <QuickActionCard key={action.title} {...action} onClick={action.title === 'Doctors' ? () => navigate('/doctors') : undefined} />)}</div>
        </section>
        ...
        <section className="dashboard-section" aria-labelledby="appointment-title">
          <div className="section-heading"><div><p>Stay on track</p><h2 id="appointment-title">Upcoming appointment</h2></div><button type="button">See all</button></div>
